...
occur in $n$ intervals is then \recall{binomially distributed}, i.e., 
...
\begin{extra}\label{ex:31}
  Show that the binomial distribution in~\eqref{eq:bin} converges to the Poisson distribution, i.e., 
