...
\begin{exercise}
  If $c$ is a constant (in $\R$) and the functions $f, g =o(h)$, then $c\cdot f = o(h)$, $f+g=o(h)$, $f(h) \to 0$ as $h\to 0$, and $f\cdot g=o(h)$. 
 \begin{solution}
First,
\begin{align*}
