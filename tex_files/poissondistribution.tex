...
\end{equation*}
Thus, if you know that an arrival occurred during $[0,t]$, the arrival is distributed
...
Again, there are two Poisson arrival processes. Let arrivals of the first type occur with rate $\lambda$, arrivals of the second  type with rate $\mu$.  Given that an arrival occurred, the next question asks you to compute  the probability that the arrival was of the first type. 
