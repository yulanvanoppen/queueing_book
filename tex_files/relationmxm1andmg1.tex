...
\end{equation}
as the distribution of the batch size $X^{(n)}$. Let the service time
...
that, in some sense, $X^{(n)}/n \to S$\footnote{For the interested, we
  mean convergence in distribution here.}.
