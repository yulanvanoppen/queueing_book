...
Lets work from top to bottom and compute anything we need along the way. First, the departure SCV. Noting that $i=1$ and $M=1$, 
\begin{equation*}
  C_{d1}^2 
...
need to use the suggested approximation.
