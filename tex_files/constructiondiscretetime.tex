...
organization considers this to be unacceptably long, but\ldots what to do about it?
...
process, cf., Section~\ref{sec:poisson-distribution}. The duration of
...
and likewise for the other queue.
  ...
  \begin{exercise} (Priority queueing) Another interesting situation is
