...
\begin{exercise} (Estimating the lead time distribution.)  Take
  ...
  \end{hint}
    \begin{solution}
      ...
      customers have been served.  Now, if $Q_{k-1}-c_k \geq 0$, there are
      ...
      front of the tagged customer are still in the system. Therefore, when the tagged customer leaves the system, the inequality $c_k+c_{k+1}+\cdots +c_m > Q_{k-1}$ must hold.
