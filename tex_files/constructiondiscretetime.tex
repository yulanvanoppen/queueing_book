...
\begin{question}[use=false](Queue with setups)
...
\begin{question} (Merging incoming streams) \tbd \emph{You can skip
  ...
  that the service capacity $c$ is contant for all periods, and that
