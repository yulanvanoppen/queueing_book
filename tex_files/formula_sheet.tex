...
& C_{sB}^2 = \frac{\V{S_s} + N \V{S_0}}{(\E{S_s} + N \E{S_0})^2} &C_s^2 = C_0^2 + 2A(1-A)\frac{m_r}{\E{S_0}}   \\
& \sigma_s^2 = \sigma_0^2 + \frac{\sigma_s^2}{N_s} + \frac{N_s -1}{N_s^2}(\E{S_s})^2 
...
& f_i(n_i) = 
            ...
            \end{cases} 
 &\quad G(i) = \sum_{n=0}^{c_i-1} \frac{(c_i\rho_i)^n}{n!} + \frac{(c_i\rho_i)^{c_i}}{c_i!}\frac{1}{1-\rho_i} \\
