...
Zijm.Ex.2.2.1
\begin{solution}
Following rate-stability we have that $\lambda<\mu_1$. If the departure rate would be equal to $\mu_1$ this would mean that jobs leave faster than they arrive, which is impossible.
\end{solution}
\end{exercise}
