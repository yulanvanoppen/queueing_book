...
It is necessary to require that $t < \lambda$ in the moment-generating function $M_X(t)$ when $X\sim\Exp(\lambda)$. 
\begin{solution} True, because
  if $t - \lambda \geq 0$, the integral becomes $\infty$. 
\end{solution}
\end{exercise}
