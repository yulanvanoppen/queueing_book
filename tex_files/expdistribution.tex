...
\end{equation*}
for the expection of $S$. Here $\d F(x)$ acts as a shorthand for $f(x) \d x$. \footnote{For the interested $\int x \d F(x)$ is a Riemann-Stieltjes integral with respect to the distribution function $F$.}
