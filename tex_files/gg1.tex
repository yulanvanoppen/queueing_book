...
\end{equation}
We refer to \cite{hopp08:_factor_physic} for a discussion of this formula and its many applications, and to \cite{bolch06:_queuein_networ_markov_chain} for related approximations.
