...
not larger than the departure rate. In particular, the load, defined
as the ratio of the arrival rate and service rate is of importance. In
...
and further background discussion.
...
rate at which jobs arrive multiplied by the average amount of work per
...
\begin{question}
 ...
 Let $T_1>A_1$ be the first time after the arrival of job 1
    ...
    at an empty system.)  Suppose, for ease of writing, that this job is
