...
With the above we have obtained the \recall{Pollackzek-Khintchine}
...
\hint{Integrate $A^{-1} \int x \d x$, and likewise for the second moment.}
\begin{solution}
  \begin{align*}
\E S &= A/2,\\
...
\begin{question}
  ...
  $\E I = 1/\lambda$.  \hint{What is the average time between two
...
\begin{question}
  What is the utilization of the $M/G/1/1$ queue?  \hint{The job in
...
\begin{question}
  ...
  (hence, what is the fraction of accepted jobs)?  \hint{The rate of
