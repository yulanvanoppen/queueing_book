...
\begin{equation}\label{eq:32}
  \lambda \E{S^2} = (1+C_s^2)\rho\E S,
\end{equation}
where the \recall{square coefficient of variation} is defined as
\begin{equation*}
...
With the simplification of the above exercise  we have obtained the fundamentally important \recall{Pollackzek-Khintchine} (PK) formula for the average waiting time in queue:
