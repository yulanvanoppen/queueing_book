...
\end{hint}
\begin{solution}
By the PASTA property we know that the probability of a busy server is defined by $P(B) = \rho$ and the probability of an idle server by $P(I)=1-\rho$. Then,
\begin{equation*}
\E{S_r} =   P(B) \cdot \E{S_r\given S_r >0} + P(I) \cdot \E{S_r\given S_r = 0} = \rho \E{S_r\given S_r >0} + (1-\rho)\cdot \E{S_r\given S_r = 0} = \rho \E{S_r\given S_r>0},
\end{equation*}
