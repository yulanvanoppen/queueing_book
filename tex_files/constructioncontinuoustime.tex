...
Right after the job moves from the queue to the server, its service starts.  Thus,~$D_{Q,k}$ is the epoch at which the service of job~$k$ starts. After completing its service,
