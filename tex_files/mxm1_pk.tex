...
\begin{equation*}
  \frac{\E{B^2}}{\E{B}} = (1+C_s^2)\E B, 
C_s^2 = \frac{\V B}{(\E B)^2},
\end{equation*}
where  $C_s^2 = \V B / (\E B)^2$ is the square coefficient of variation of the batch sizes.  
  \begin{solution}
We have
\begin{align*}
  \frac{\E{B^2}}{\E{B}}
...
\end{equation}
Second, for the expected number of items in the system we find
