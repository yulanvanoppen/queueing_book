...
\item I expect you to be familiar with the most important \emph{notation} used in the book. For instance, you should know what is meant with $M^X/M/1$, or with $A(t)$ or $A(n,t)$, or $\pi(n)$.  Definitions that are used only once, such  $A(m,n,t)$, will defined in the exam. 
